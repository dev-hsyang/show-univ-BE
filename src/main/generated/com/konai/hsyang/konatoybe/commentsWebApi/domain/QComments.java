...
public class QComments extends EntityPathBase<Comments> {
    ...
    private static final long serialVersionUID = -682306745L;
    ...
    public final com.konai.hsyang.konatoybe.postsWebApi.domain.QPosts post;
    ...
    public QComments(Class<? extends Comments> type, PathMetadata metadata, PathInits inits) {
        ...
        this.post = inits.isInitialized("post") ? new com.konai.hsyang.konatoybe.postsWebApi.domain.QPosts(forProperty("post"), inits.get("post")) : null;
