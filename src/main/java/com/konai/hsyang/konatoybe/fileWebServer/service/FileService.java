package com.konai.hsyang.konatoybe.fileWebServer.service;
...
import com.konai.hsyang.konatoybe.fileWebServer.repository.FileRepository;
import com.konai.hsyang.konatoybe.fileWebServer.util.FileUtils;
...
public class FileService {
    ...
    public com.konai.hsyang.konatoybe.fileWebServer.domain.File save(FileSaveRequestDto requestDto){

        return fileRepository.save(requestDto.toEntity());
    }

    public com.konai.hsyang.konatoybe.fileWebServer.domain.File findById(Long fileID){
