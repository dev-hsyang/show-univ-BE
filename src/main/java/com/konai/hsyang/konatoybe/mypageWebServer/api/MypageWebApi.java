package com.konai.hsyang.konatoybe.mypageWebServer.api;
...
@RestController
public class MypageWebApi {

    private final UserService userService;

    @PostMapping("/api/v2/mypage/update-nickname/{id}")
    ...
    @PostMapping("/api/v2/mypage/update-password/{id}")
    ...
    @PostMapping("/api/v2/mypage/delete/{id}")
